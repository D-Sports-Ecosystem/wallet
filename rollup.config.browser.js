...
export default {
  ...
  plugins: [
    ...
    terser(),
    visualizer({
      filename: 'dist/stats-browser-specific.html',
      title: 'D-Sports Wallet Browser-Specific Bundle Analysis',
      gzipSize: true,
      brotliSize: true
    })
  ],
  external: (id) => {
    ...
    const peerDeps = ['react', 'react-dom', 'framer-motion', 'lucide-react', 'ethers', 'viem'];
